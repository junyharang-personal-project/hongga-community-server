...
@Slf4j
public class PaternalMemberAPIInterCeptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        log.info("이용자의 등급이 PATERNAL 이상 회원 역할이 접근 가능한 곳이 아니라면 접근 제한 하겠습니다!");

        if (memberRole.equals(MemberRole.ROLE_GUEST.getKey()) || memberRole.equals(MemberRole.ROLE_FRIEND.getKey())) {

            log.error("이용자의 등급이 PATERNAL 이하 등급 입니다! 접근 제한 하겠습니다!\");");
